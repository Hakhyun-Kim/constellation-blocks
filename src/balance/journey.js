...
export const JOURNEY_CHAPTER = {
  ...
  nodes: [
    ...
    { id: 'meadow', kind: 'battle', icon: '⚔', name: '푸른 초원', text: '먼저 다가오는 무리를 막아 길을 확보한다.', x: 24, y: 56, waves: 2, threat: 1, next: ['relic', 'town'] },
    { id: 'relic', kind: 'treasure', icon: '✧', name: '달의 유물', text: '빛나는 보급품이 성의 방어를 보탠다.', x: 42, y: 27, gold: 80, heal: 16, next: ['observatory'] },
    { id: 'town', kind: 'town', icon: '⌂', name: '갈림길 마을', text: '누구를 먼저 설득할지 선택한다.', x: 43, y: 79, offers: ['doyun', 'sera'], next: ['camp'] },
    ...
    { id: 'boss', kind: 'boss', icon: '♜', name: '붉은 성문', text: '성도를 노리는 군세의 지휘관이 길을 막는다.', x: 89, y: 56, waves: 5, threat: 7, next: [] },
  ],
};
